...
public static class ServiceCollectionExtensions
{
        ...
        string clientSecret, Region region, Locale locale)
    {
        ...
        services.AddHttpClient(
            ...
            new WarcraftClient(clientId, clientSecret, region, locale, new RateLimitedHttpClient (httpClient)) //changed to Rate Limited to enabled rate limiting requests for httpClient
        );
